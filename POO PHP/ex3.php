        ...
        <?php
            ...
            class Documento {
                ...
                public static function validarCPF($cpf):boot{
                    ...
                    //Verifica se nenhuma das sequências abaixo foi digitada, caso afirmativo retorna falso
            ...
            $cpf = new Documento();
            $cpf->setNumero("35973652808");

            var_dump($cpf->getNumero());

            //Validar sem instanciar classe
            //var_dump(Documento::validarCPF("35973652807"));  
